      ...
      <div className="flex flex-col md:flex-row space-x-4">
        ...
        <div className="flex-grow">
          <h1 className="text-4xl leading-tight text-gray-900 pb-2 mb-4 border-b-2">
            佐藤憲匡{' '}
            <span className="text-xl text-gray-500">Kadumasa Sato</span>
          </h1>
          <div className="flex flex-row justify-start mb-4 space-x-4">
            <a
              href="https://github.com/satokadumasa"
              target="_blank"
            ...
            <a
              href="https://twitter.com/susanoo"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.facebook.com/sato.kadumasa/"
              target="_blank"
              rel="noopener noreferrer"
            >
